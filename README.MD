...
0. In order to run this script you must copy the "Decremental Files Sync Current Dir Win.exe" in the Source directory (the directory you want files copied from).
